...
#
LOGDIR = 'C:/Users/Sai Srinivas/Downloads/technocolabs/Dataset1/'
classes=['labels_1024.tsv','sprite_1024.png']
LABELS = os.path.join(LOGDIR, classes[0])
SPRITES = os.path.join(LOGDIR, classes[1])
